...
const searchInput = document.getElementById("searchInput");  // input da busca por nome
const typeFilter = document.getElementById("typeFilter");    // select do filtro de tipo
const recipesList = document.getElementById("recipesList");  // container onde as receitas são renderizadas
...
async function carregarReceitas() {
  try {
    ...
    renderReceitas();  // <--- chama aqui para atualizar a lista
  } catch (erro) {
...
const unidades = ['unidades', 'gramas', 'ml', 'kilogramas', 'litros'];
